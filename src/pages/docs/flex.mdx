...
<Example resizable>
  <div class="mt-2 flex gap-4 text-white text-sm font-bold font-mono leading-6 bg-stripes-zinc rounded-lg">
    <div class="p-4 flex-none w-14 h-14 rounded-lg flex items-center justify-center bg-zinc-300 dark:bg-zinc-800 dark:text-zinc-500">01</div>
    <div class="p-4 flex-initial w-24 sm:w-64 rounded-lg flex items-center justify-center bg-zinc-500 shadow-lg">02</div>
    <div class="p-4 flex-initial w-14 sm:w-32 rounded-lg flex items-center justify-center bg-zinc-500 shadow-lg">03</div>
  </div>
</Example>
