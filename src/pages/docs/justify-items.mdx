...
<Example>
  <div class="grid grid-cols-3 gap-4 font-mono text-white text-sm font-bold leading-6">
    <div class="bg-stripes-blue grid rounded-lg justify-items-start">
    ...
    <div class="bg-stripes-blue grid rounded-lg justify-items-start">
      <div class="w-14 h-14 rounded-lg flex items-center justify-center bg-blue-500 shadow-lg">04</div>
    </div>
    <div class="bg-stripes-blue grid rounded-lg justify-items-start">
      <div class="w-14 h-14 rounded-lg flex items-center justify-center bg-blue-500 shadow-lg">05</div>
    </div>
    <div class="bg-stripes-blue grid rounded-lg justify-items-start">
      <div class="w-14 h-14 rounded-lg flex items-center justify-center bg-blue-500 shadow-lg">06</div>
    </div>
  </div>
</Example>
...
<Example>
  <div class="grid grid-cols-3 gap-4 justify-items-stretch font-mono text-white text-sm font-bold leading-6">
    <div class="h-14 rounded-lg flex items-center justify-center bg-zinc-500 shadow-lg">01</div>
    <div class="h-14 rounded-lg flex items-center justify-center bg-zinc-500 shadow-lg">02</div>
    <div class="h-14 rounded-lg flex items-center justify-center bg-zinc-500 shadow-lg">03</div>
    <div class="h-14 rounded-lg flex items-center justify-center bg-zinc-500 shadow-lg">04</div>
    <div class="h-14 rounded-lg flex items-center justify-center bg-zinc-500 shadow-lg">05</div>
    <div class="h-14 rounded-lg flex items-center justify-center bg-zinc-500 shadow-lg">06</div>
  </div>
</Example>
