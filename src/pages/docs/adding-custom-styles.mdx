...
<details className="-mt-0 mb-6 rounded-xl border px-6 py-3 prose prose-zinc open:pb-5 dark:prose-dark dark:border-zinc-800">
  <summary className="font-medium cursor-default select-none text-zinc-900 dark:text-zinc-200">Why does Tailwind group styles into "layers"?</summary>
