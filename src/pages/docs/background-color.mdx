...
<Example>
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 text-sm text-white">
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">bg-blue-500</p>
      <button class="px-4 py-2 font-semibold text-sm bg-blue-500 text-white rounded-md shadow-sm opacity-100">Button A</button>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">bg-blue-500/75</p>
      <button class="px-4 py-2 font-semibold text-sm bg-blue-500/75 text-white rounded-md shadow-sm opacity-100">Button B</button>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">bg-blue-500/50</p>
      <button class="px-4 py-2 font-semibold text-sm bg-blue-500/50 text-white rounded-md shadow-sm opacity-100">Button C</button>
    </div>
  </div>
</Example>

```html
<button class="bg-blue-500**/100** ..."></button>
<button class="bg-blue-500**/75** ..."></button>
<button class="bg-blue-500**/50** ..."></button>
```
...
```html
<button class="bg-zinc-500 **md:bg-green-500** ...">Subscribe</button>
```
