...
| `unit_price` | `object` | The [unit price object](#the-unit-price-object). |
| `value` | `object` | The [value object](#the-value-object). |
| `links` | `object` | The [links object](#the-links-object). |
| `meta` | `object` | The [meta object](#the-links-object). |
