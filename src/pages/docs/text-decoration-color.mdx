...
<HoverFocusAndOtherStates defaultClass="underline decoration-sky-600" featuredClass="decoration-zinc-400" element="p" />

### <Heading ignore>Breakpoints and media queries</Heading>

<BreakpointsAndMediaQueries defaultClass="underline decoration-sky-600" featuredClass="decoration-zinc-400" element="p" />
