...
<Example>
  <div class="grid grid-cols-6 gap-4 font-mono text-white text-sm text-center font-bold leading-6">
    <div class="p-4 rounded-lg bg-stripes-blue"></div>
    <div class="p-4 rounded-lg shadow-lg bg-blue-500 col-start-2 col-span-4">01</div>
    <div class="p-4 rounded-lg bg-stripes-blue"></div>
    <div class="p-4 rounded-lg shadow-lg bg-blue-500 col-start-1 col-end-3">02</div>
    <div class="p-4 rounded-lg bg-stripes-blue"></div>
    <div class="p-4 rounded-lg bg-stripes-blue"></div>
    <div class="p-4 rounded-lg shadow-lg bg-blue-500 col-end-7 col-span-2">03</div>
    <div class="p-4 rounded-lg shadow-lg bg-blue-500 col-start-1 col-end-7">04</div>
  </div>
</Example>
