---
id: update-a-user-authentication-oidc-profile-info
title: Update a User Authentication OpenID Connect Profile Info
sidebar_label: Update a User Authentication OpenID Connect Profile Info
---
...
```bash
curl -X PUT https://api.moltin.com/v2/authentication-realms/:id/user-authentication-info/:id2/user-authentication-oidc-profile-info/:user-authentication-oidc-profile-info-id/ \
