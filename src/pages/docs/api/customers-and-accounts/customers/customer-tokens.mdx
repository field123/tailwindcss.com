...
For more information on requesting a customer token with OpenID Connect, refer to the Developer How-To: [Single sign-on with OpenID Connect](../../../developer/how-to/get-single-sign-on-customer-token.md).
...
- [Get a Customer](get-a-customer.md)
- [Update a Customer](update-a-customer.md)
- [Get Customer Addresses](../addresses/get-all-addresses.md)
- [Get an Address](../addresses/get-an-address.md)
- [Create an Address](../addresses/create-an-address.md)
- [Update an Address](../addresses/update-an-address.md)
- [Get all Orders](../../carts-and-orders/orders/get-all-orders.md)
- [Get an Order](../../carts-and-orders/orders/get-an-order.md)
- [Get Customer Carts](../../carts-and-orders/carts/associations/get-customer-carts.md)
- [Create an Association between a Customer and a Cart](../../carts-and-orders/carts/associations/create-an-association.md)
- [Delete an Association Between a Customer and a Cart](../../carts-and-orders/carts/associations/delete-an-association.md)
