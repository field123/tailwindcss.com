...
<Example p="none" lightOnly={true}>
  ...
  <div class="flex items-center justify-around gap-6 sm:gap-4 font-mono font-bold shrink-0 p-8">
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3">drop-shadow-md</p>
      <div class="drop-shadow-md">
        <div class="w-24 h-24 bg-white rounded-lg"></div>
      </div>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3">drop-shadow-lg</p>
      <div class="drop-shadow-lg">
        <div class="w-24 h-24 bg-white rounded-lg"></div>
      </div>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3">drop-shadow-xl</p>
      <div class="drop-shadow-xl">
        <div class="w-24 h-24 bg-white rounded-lg"></div>
      </div>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3">drop-shadow-2xl</p>
