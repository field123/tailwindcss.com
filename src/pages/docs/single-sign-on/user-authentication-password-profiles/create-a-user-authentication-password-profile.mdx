---
id: create-a-user-authentication-password-profile
title: Create a User Authentication Password Profile
sidebar_label: Create a User Authentication Password Profile
---
...
| `password` | Required | `string` | The password used to authenticate. |
...
```bash
curl -X POST https://api.moltin.com/v2/authentication-realms/:realm-id/user-authentication-info/:user-authentication-info-id/user-authentication-password-profile-info/ \
