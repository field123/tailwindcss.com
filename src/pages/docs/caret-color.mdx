...
<Example hint="Focus the textarea to see the new caret color">
  <div class="w-full flex items-center justify-center">
    <textarea class="text-sm p-2 w-80 ring-1 ring-zinc-900/10 shadow-sm rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500 caret-pink-500 dark:bg-zinc-800 dark:ring-0 dark:highlight-white/5 dark:focus:ring-2 dark:focus:ring-pink-500 dark:focus:bg-zinc-900" rows="2"></textarea>
  </div>
</Example>
...
```html
<textarea class="caret-zinc-500 **focus:caret-indigo-500**"></textarea>
```
...
```html
<textarea class="caret-zinc-500 **md:caret-indigo-500**"></textarea>
```
