...
<Example>
  <div class="space-y-4">
    <div class="h-14 rounded-lg bg-gradient-to-r from-cyan-500 to-zinc-500"></div>
    <div class="h-14 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-500"></div>
...
```html
<div class="h-14 **bg-gradient-to-r from-cyan-500 to-zinc-500**"></div>
<div class="h-14 **bg-gradient-to-r from-blue-500 to-indigo-500**"></div>
