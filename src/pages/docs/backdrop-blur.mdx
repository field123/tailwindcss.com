...
<Example p="none">
  ...
  <div class="flex items-center justify-around gap-6 sm:gap-4 font-mono font-bold shrink-0 p-8">
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">backdrop-blur-sm</p>
      <div class="relative">
    ...
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">backdrop-blur-md</p>
      <div class="relative">
    ...
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">backdrop-blur-xl</p>
      <div class="relative">
