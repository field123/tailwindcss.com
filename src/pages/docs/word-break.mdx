...
<Example p="none">
  <div class="overflow-x-scroll sm:overflow-x-visible px-4">
    <div class="mx-auto max-w-sm bg-white shadow-xl p-8 text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400">
      <p class="break-normal">The longest word in any of the major English language dictionaries is
      <span class="text-zinc-900 font-medium dark:text-zinc-200">pneumonoultramicroscopicsilicovolcanoconiosis,</span>
