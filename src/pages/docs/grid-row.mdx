...
<Example>
  <div class="grid grid-rows-3 grid-flow-col gap-4 font-mono text-white text-sm text-center font-bold leading-6 bg-stripes-blue rounded-lg">
    <div class="p-4 sm:p-12 rounded-lg shadow-lg bg-zinc-500 grid place-content-center row-start-2 row-span-2">01</div>
    <div class="p-4 sm:p-12 rounded-lg shadow-lg bg-zinc-500 grid place-content-center row-end-3 row-span-2">02</div>
    <div class="p-4 sm:p-12 rounded-lg shadow-lg bg-zinc-500 grid place-content-center row-start-1 row-end-4">03</div>
  </div>
</Example>
