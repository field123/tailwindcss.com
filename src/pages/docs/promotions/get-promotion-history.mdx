---
id: get-promotion-history
title: Get Promotion History
sidebar_label: Get Promotion History
---
...
```http
https://api.moltin.com/v2/promotions/{{promotionId}}/history
```
...
```bash
curl https://api.moltin.com/v2/promotions/{{promotionID}}/history\
