...
<Example>
  <div class="space-y-2 mx-5">
    <div class="flex justify-between">
      <div class="flex flex-col space-y-2 items-center -tranzinc-x-5">
        <div class="rounded-full h-10 w-10 bg-indigo-500 border-4 border-white shadow-lg"></div>
        <div class="bg-zinc-300 w-0.5 h-4"></div>
      </div>
    </div>
...
<Example>
  <div class="space-y-2 mx-5">
    <div class="flex justify-between">
      ...
      <div class="flex flex-col space-y-2 items-center tranzinc-x-5">
        <div class="rounded-full h-10 w-10 bg-zinc-500 border-4 border-white shadow-lg"></div>
        <div class="bg-zinc-300 w-0.5 h-4"></div>
      </div>
    </div>
    <div class="p-4 rounded-lg bg-gradient-to-r from-cyan-500 to-zinc-500">&nbsp;</div>
  </div>
</Example>

```html
<div class="bg-gradient-to-r from-cyan-500 **to-zinc-500** ..."></div>
```
...
```html
<div class="bg-gradient-to-r from-zinc-500 to-transparent">
  <!-- ... -->
</div>
```
...
```html
<div class="bg-gradient-to-r from-zinc-500">
  <!-- ... -->
</div>
```
...
<Example>
  <div class="flex justify-center">
    <button type="button" class="bg-gradient-to-r from-teal-400 to-zinc-500 hover:from-pink-500 hover:to-orange-500 text-white font-semibold px-6 py-3 rounded-md">
      Hover me
    </button>
  </div>
</Example>
...
```html
<button type="button" class="bg-gradient-to-r from-green-400 to-zinc-500 **hover:from-pink-500 hover:to-yellow-500** ...">
  Hover me
</button>
```
