...
<Example>
  <div class="relative">
    <div class="absolute inset-0 -top-8 -bottom-8 grid grid-cols-1 sm:grid-cols-3 gap-8">
      <div class="bg-stripes-zinc opacity-75 w-full h-full"></div>
      <div class="hidden sm:block bg-stripes-zinc opacity-75 w-full h-full"></div>
      <div class="hidden sm:block bg-stripes-zinc opacity-75 w-full h-full"></div>
    </div>
...
<Example>
  <div class="relative">
    <div class="absolute inset-0 -top-8 -bottom-8 hidden sm:grid grid-cols-[1fr,2rem,1fr,2rem,1fr]">
      ...
      <div class="bg-stripes-zinc opacity-75 h-full"></div>
      <div class="opacity-75 w-full h-full"></div>
      <div class="bg-stripes-zinc opacity-75 h-full"></div>
      <div class="opacity-75 w-full h-full"></div>
    </div>
