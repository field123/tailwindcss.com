...
<Example>
  <div class="flex flex-nowrap gap-4 font-mono text-white text-sm font-bold leading-6 bg-stripes-blue rounded-lg">
    <div class="w-2/5 flex-none last:pr-8">
      <div class="p-4 w-full rounded-lg flex items-center justify-center bg-blue-500 shadow-lg">01</div>
    </div>
    <div class="w-2/5 flex-none last:pr-8">
      <div class="p-4 w-full rounded-lg flex items-center justify-center bg-blue-500 shadow-lg">02</div>
    </div>
    <div class="w-2/5 flex-none last:pr-8">
      <div class="p-4 w-full rounded-lg flex items-center justify-center bg-blue-500 shadow-lg">03</div>
    </div>
  </div>
</Example>
