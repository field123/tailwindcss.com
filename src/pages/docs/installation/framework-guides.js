...
export default function FrameworkGuides() {
  return (
    <InstallationLayout>
      <div id="content-wrapper" className="prose prose-zinc mb-10 max-w-3xl dark:prose-dark">
        ...
        {[
          ...
          <li key={name} className="relative flex flex-row-reverse">
            <div className="peer group ml-6 flex-auto">
              <h4 className="mb-2 leading-6 text-zinc-900 font-semibold dark:text-zinc-200">
              ...
              <p className="text-sm leading-6 text-zinc-700 dark:text-zinc-400">{description}</p>
            </div>
            <div className="flex-none w-14 h-14 rounded-full bg-white ring-1 ring-zinc-900/5 shadow flex items-center justify-center overflow-hidden dark:bg-zinc-800 dark:highlight-white/5">
              {LogoDark !== undefined ? (
                <>
            ...
            <div className="absolute -z-10 -inset-3 rounded-2xl bg-zinc-50 dark:bg-zinc-800/50 opacity-0 peer-hover:opacity-100" />
          </li>
        ))}
      </ul>
      <div className="mt-16 prose prose-zinc max-w-3xl dark:prose-dark">
        <p>
