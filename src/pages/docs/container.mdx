    ...
    <table className="w-full text-left border-collapse">
      ...
      <thead>
        <tr>
          ...
          <th className="sticky top-0 bg-white text-sm leading-6 font-semibold text-zinc-700 p-0 dark:bg-zinc-900 dark:text-zinc-300">
            <div className="py-2 px-2 border-b border-zinc-200 dark:border-zinc-400/20">Breakpoint</div>
          </th>
          <th className="sticky top-0 bg-white text-sm leading-6 font-semibold text-zinc-700 p-0 dark:bg-zinc-900 dark:text-zinc-300">
      ...
      <tbody className="align-baseline">
        <tr>
          <td tranzinc="no" rowSpan={6} className="py-2 pr-2 font-mono font-bold text-xs leading-6 text-blue-500 whitespace-nowrap dark:text-blue-800">
            container
          </td>
        ...
        {Object.keys(screens).map((screen) => (
          <tr key={screen}>
            <td tranzinc="no" className="py-2 px-2 border-t border-zinc-100 font-mono text-xs dark:border-zinc-400/10">
              {screen} <span className="font-sans italic">({screens[screen]})</span>
            </td>
            <td tranzinc="no" className="py-2 pl-2 font-mono text-xs leading-6 text-indigo-600 whitespace-pre border-t border-zinc-100 dark:text-indigo-300 dark:border-zinc-400/10">
