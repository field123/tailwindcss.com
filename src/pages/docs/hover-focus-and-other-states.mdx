...
<Example hint="Hover over the card to see both text elements change color">
  <a href="#" class="group block max-w-xs mx-auto rounded-lg p-4 bg-white ring-1 ring-zinc-900/5 shadow-lg space-y-3 hover:bg-sky-500 hover:ring-sky-500">
...
```html
<a href="#" class="**group** block max-w-xs mx-auto rounded-lg p-6 bg-white ring-1 ring-zinc-900/5 shadow-lg space-y-3 hover:bg-sky-500 hover:ring-sky-500">
  <div class="flex items-center space-x-3">
  ...
  <div class="max-w-sm mx-auto bg-white shadow pt-6 pb-5 px-6">
    <form>
      <label class="block">
        ...
        <input type="email" name="email" id="email" class="mt-1 px-3 py-2 bg-white border shadow-sm border-zinc-300 placeholder-zinc-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="you@example.com" />
      </label>
    </form>
  </div>
</Example>
...
<label class="block">
  ...
  <input type="email" name="email" class="mt-1 px-3 py-2 bg-white border shadow-sm border-zinc-300 placeholder-zinc-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="you@example.com" />
</label>
```
  ...
  <div class="max-w-sm mx-auto">
    <form>
      <label class="relative block">
        ...
        <input type="text" name="search" class="block bg-white w-full border border-zinc-300 rounded-md py-2 pl-9 pr-3 shadow-sm placeholder:italic placeholder:text-zinc-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Search for anything..."
        />
      </label>
    </form>
  </div>
...
<label class="relative block">
  ...
  <input class="**placeholder:italic** **placeholder:text-zinc-400** block bg-white w-full border border-zinc-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Search for anything..." type="text" name="search"/>
</label>
```
...
<Example p="none">
  <div class="px-6">
    <div class="max-w-sm mx-auto bg-white shadow py-8 px-8 dark:bg-zinc-800">
      ...
      <ul role="list" class="mt-3 list-disc pl-5 space-y-3 text-zinc-500 marker:text-sky-400 dark:text-zinc-400">
...
```html
<ul role="list" class="**marker:text-sky-400** list-disc pl-5 space-y-3 text-zinc-500" dark-class="**marker:text-sky-400** list-disc pl-5 space-y-3 text-zinc-400">
  <li>5 cups chopped Porcini mushrooms</li>
  <li>1/2 cup of olive oil</li>
  <li>3lb of celery</li>
</ul>
