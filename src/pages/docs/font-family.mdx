...
<Example>
  <div class="flex flex-col gap-8">
    <div>
      <span class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">font-sans</span>
      <p class="font-sans text-lg font-medium text-zinc-900 dark:text-zinc-200">
        The quick brown fox jumps over the lazy dog.
      </p>
    </div>
    <div>
      <span class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">font-serif</span>
      <p class="font-serif text-lg font-medium text-zinc-900 dark:text-zinc-200">
        The quick brown fox jumps over the lazy dog.
      </p>
    </div>
    <div>
      <span class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">font-mono</span>
      <p class="font-mono text-lg font-medium text-zinc-900 dark:text-zinc-200">
        The quick brown fox jumps over the lazy dog.
      </p>
    </div>
  </div>
