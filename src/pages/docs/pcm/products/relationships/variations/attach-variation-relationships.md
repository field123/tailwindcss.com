---
id: create-variation-relationships
title: Create Variation Relationships
sidebar_label: Create Variation Relationship
---
...
```bash
curl -X POST https://api.moltin.com/pcm/products/:productId/relationships/variations \
