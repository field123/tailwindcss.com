...
```text
https://api.moltin.com/catalog/hierarchies/:hierarchyId/products
```
...
```bash
curl -X GET https://api.moltin.com/catalog/hierarchies/0e119de2-5fb0-4bca-9b84-b3fc6c903007/products \
