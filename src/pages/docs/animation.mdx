  ...
  custom: (
    <table className="w-full text-left border-collapse">
      ...
      <tbody className="align-baseline">
        <tr>
          <td tranzinc="no" className="py-2 pr-2 font-mono font-bold text-xs leading-6 text-sky-500 whitespace-nowrap dark:text-sky-400">
            animate-none
          </td>
        ...
        <tr>
          <td tranzinc="no" className="py-2 pr-2 font-mono font-bold text-xs leading-6 text-sky-500 whitespace-nowrap border-t border-zinc-100 dark:border-zinc-400/10 dark:text-sky-400">
            animate-spin
          </td>
...
<Example>
  <div class="flex items-center justify-center">
    <span class="relative inline-flex">
      <button type="button" class="inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-md text-sky-500 bg-white dark:bg-zinc-800 transition ease-in-out duration-150 cursor-not-allowed ring-1 ring-zinc-900/10 dark:ring-zinc-200/20" disabled>
        Transactions
      </button>
