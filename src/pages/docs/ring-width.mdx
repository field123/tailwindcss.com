...
Use the `ring-{width}` utilities to apply solid box-shadow of a specific thickness to an element. Rings are a semi-transparent zinc color by default, similar to the default focus ring style in many systems.

<Example>
  <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-white text-center font-bold leading-6">
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">ring-2</p>
      <button class="px-4 py-2 font-semibold text-sm bg-white text-zinc-700 border border-zinc-300 rounded-md shadow-sm ring-2 ring-offset-2 ring-offset-zinc-50 ring-zinc-300 dark:bg-zinc-700 dark:text-zinc-200 dark:ring-offset-zinc-900 dark:border-transparent">Button A</button>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">ring</p>
        <button class="px-4 py-2 font-semibold text-sm bg-white text-zinc-700 border border-zinc-300 rounded-md shadow-sm ring ring-offset-2 ring-offset-zinc-50 ring-zinc-300 dark:bg-zinc-700 dark:text-zinc-200 dark:ring-offset-zinc-900 dark:border-transparent">Button B</button>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">ring-4</p>
      <button class="px-4 py-2 font-semibold text-sm bg-white text-zinc-700 border border-zinc-300 rounded-md shadow-sm ring-4 ring-offset-2 ring-offset-zinc-50 ring-zinc-300 dark:bg-zinc-700 dark:text-zinc-200 dark:ring-offset-zinc-900 dark:border-transparent">Button C</button>
    </div>
  </div>
</Example>
...
<Example hint="Focus this button to see the ring appear">
  <div class="flex justify-center max-w-md mx-auto gap-4 text-white text-sm text-center font-bold leading-6">
    <button class="px-4 py-2 font-semibold text-sm bg-white text-zinc-700 border border-zinc-300 rounded-md shadow-sm ring-violet-300 ring-offset-2 ring-offset-zinc-50 focus:outline-none focus:ring-2 dark:bg-zinc-700 dark:text-zinc-200 dark:border-transparent">Save Changes</button>
  </div>
</Example>
...
<Example>
  <div class="flex justify-center max-w-md mx-auto gap-4 text-white text-sm text-center font-bold leading-6">
    <button class="px-4 py-2 font-semibold text-sm bg-white text-zinc-700 rounded-md shadow-sm ring-pink-300 ring-2 ring-inset dark:bg-zinc-700 dark:text-zinc-200 dark:ring-pink-500">Save Changes</button>
  </div>
</Example>
