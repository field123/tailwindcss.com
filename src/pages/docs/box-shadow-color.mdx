...
<HoverFocusAndOtherStates defaultClass="shadow shadow-zinc-500/40" featuredClass="shadow-indigo-500/40" element="button" />

### <Heading ignore>Breakpoints and media queries</Heading>

<BreakpointsAndMediaQueries defaultClass="shadow shadow-zinc-500/40" featuredClass="shadow-indigo-500/40" element="button" />
