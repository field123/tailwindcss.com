...
<Example>
  <div class="flex flex-col gap-8 text-zinc-900 dark:text-zinc-200">
    <div>
      <div class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">decoration-solid</div>
      <p class="text-lg font-medium underline decoration-solid">The quick brown fox jumps over the lazy dog.</p>
    </div>
    <div>
      <div class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">decoration-double</div>
      <p class="text-lg font-medium underline decoration-double">The quick brown fox jumps over the lazy dog.</p>
    </div>
    <div>
      <div class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">decoration-dotted</div>
      <p class="text-lg font-medium underline decoration-dotted">The quick brown fox jumps over the lazy dog.</p>
    </div>
    <div>
      <div class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">decoration-dashed</div>
      <p class="text-lg font-medium underline decoration-dashed">The quick brown fox jumps over the lazy dog.</p>
    </div>
    <div>
      <div class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">decoration-wavy</div>
