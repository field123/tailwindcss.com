...
<Example>
  <div class="font-mono text-white text-sm font-bold leading-6">
    <div class="flex items-stretch gap-4 w-full rounded-lg bg-stripes-blue h-24">
      <div class="p-4 flex-1 flex items-center justify-center rounded-lg bg-blue-300 dark:bg-blue-800 dark:text-blue-500">01</div>
      <div class="self-auto p-4 flex-1 flex items-center justify-center shadow-lg rounded-lg bg-blue-500">02</div>
      <div class="p-4 flex-1 flex items-center justify-center rounded-lg bg-blue-300 dark:bg-blue-800 dark:text-blue-500">03</div>
    </div>
  </div>
</Example>
