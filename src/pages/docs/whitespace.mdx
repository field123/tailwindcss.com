...
<Example p="none">
  <div class="bg-white p-8 shadow-xl text-zinc-700 max-w-md mx-auto overflow-auto text-sm leading-6 sm:text-base sm:leading-7 dark:bg-zinc-800 dark:text-zinc-400">
...
<Example p="none">
  <div class="bg-white px-6 py-8 shadow-xl text-zinc-700 max-w-md mx-auto overflow-auto text-sm leading-6 sm:text-base sm:leading-7 dark:bg-zinc-800 dark:text-zinc-400">
