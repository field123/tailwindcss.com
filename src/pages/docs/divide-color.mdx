...
<Example p="none">
  <div class="grid grid-cols-1 divide-y divide-zinc-200 font-mono text-white text-sm text-center font-bold leading-6 shadow-lg overflow-hidden max-w-sm mx-auto">
    <div class="p-4 text-zinc-500 bg-white">01</div>
    <div class="p-4 text-zinc-500 bg-white">02</div>
    <div class="p-4 text-zinc-500 bg-white">03</div>
  </div>
</Example>
...
<Example p="none">
  <div class="grid grid-cols-1 divide-y-4 divide-zinc-400/25 font-mono text-white text-sm text-center font-bold leading-6 shadow-lg overflow-hidden max-w-sm mx-auto">
    <div class="p-4 text-zinc-400 bg-white">01</div>
    <div class="p-4 text-zinc-400 bg-white">02</div>
    <div class="p-4 text-zinc-400 bg-white">03</div>
  </div>
</Example>

```html
<div class="divide-y-4 divide-zinc-400**/25** ...">
  <!-- ... -->
</div>
```
...
```html
<div class="divide-y-4 divide-zinc-400**/[.24]** ...">
  <!-- ... -->
</div>
```
