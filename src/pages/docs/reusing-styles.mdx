...
<Example p="none">
  <div class="w-72 sm:w-96 px-8 sm:px-12 py-6 sm:py-8 mx-auto bg-white shadow">
    <div class="flex text-base items-center space-x-2">
      <h4 class="text-base font-semibold text-zinc-900">Contributors</h4>
      <span class="text-xs rounded-full px-2 py-1 bg-zinc-100 font-semibold text-zinc-700">204</span>
    </div>
    ...
    <div class="mt-3 text-sm font-medium">
      <a href="#" class="text-zinc-500">+ 198 others</a>
    </div>
  </div>
</Example>
...
<div>
  <div class="flex items-center space-x-2 text-base">
    <h4 class="font-semibold text-zinc-900">Contributors</h4>
    <span class="rounded-full bg-zinc-100 px-2 py-1 text-xs font-semibold text-zinc-700">204</span>
  </div>
  <div class="mt-3 flex -space-x-2 overflow-hidden">
    <img class="**inline-block h-12 w-12 rounded-full ring-2 ring-white**" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt=""/>
    <img class="**inline-block h-12 w-12 rounded-full ring-2 ring-white**" src="https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt=""/>
  ...
  <div class="sm:px-8 flex sm:justify-center">
    <div class="bg-white px-6 py-4 shadow">
      <nav class="flex justify-center space-x-4">
        <a href="#/dashboard" class="rounded-lg px-3 py-2 text-zinc-700 font-medium hover:bg-zinc-100 hover:text-zinc-900">Home</a>
        <a href="#/team" class="rounded-lg px-3 py-2 text-zinc-700 font-medium hover:bg-zinc-100 hover:text-zinc-900">Team</a>
        <a href="#/projects" class="rounded-lg px-3 py-2 text-zinc-700 font-medium hover:bg-zinc-100 hover:text-zinc-900">Projects</a>
        <a href="#/reports" class="rounded-lg px-3 py-2 text-zinc-700 font-medium hover:bg-zinc-100 hover:text-zinc-900">Reports</a>
      </nav>
    </div>
  </div>
</Example>
...
<nav className="flex sm:justify-center space-x-4">
  {[
    ...
    <a href={url} className="rounded-lg px-3 py-2 text-zinc-700 font-medium hover:bg-zinc-100 hover:text-zinc-900">{title}</a>
  ))}
</nav>
```
...
<Example p="none">
  <div class="w-72 sm:w-96 px-8 sm:px-12 py-6 sm:py-8 mx-auto bg-white shadow">
    <div>
      ...
      <div class="mt-2">
        <div>
          <div class="text-xs text-zinc-600 uppercase font-bold tracking-wider">Private Villa</div>
          <div class="font-bold text-zinc-700 leading-snug">
            <a href="#" class="hover:underline">Relaxing All-Inclusive Resort in Cancun</a>
          </div>
          <div class="mt-2 text-sm text-zinc-600">$299 USD per night</div>
        </div>
      </div>
    </div>
  </div>
...
<template>
  <div>
    ...
    <div class="mt-2">
      <div>
        <div class="text-xs text-zinc-600 uppercase font-bold tracking-wider">{{ eyebrow }}</div>
        <div class="font-bold text-zinc-700 leading-snug">
          <a :href="url" class="hover:underline">{{ title }}</a>
        </div>
        <div class="mt-2 text-sm text-zinc-600">{{ pricing }}</div>
      </div>
    </div>
  </div>
</template>
...
<button class="py-2 px-4 bg-zinc-500 text-white font-semibold rounded-lg shadow-md hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-zinc-400 focus:ring-opacity-75">
  Save changes
</button>
...
@layer components {
  .btn-primary {
    @apply py-2 px-4 bg-zinc-500 text-white font-semibold rounded-lg shadow-md hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-zinc-400 focus:ring-opacity-75;
  }
}
```
...
Whatever you do, **don't use <code className="font-semibold text-zinc-900">@apply</code> just to make things look "cleaner"**. Yes, HTML templates littered with Tailwind classes are kind of ugly. Making changes in a project that has tons of custom CSS is worse.
