...
<Example>
  <p class="font-source ordinal text-center text-zinc-900 text-lg dark:text-zinc-200">1st</p>
</Example>
...
<Example>
  <p class="font-source slashed-zero text-center text-zinc-900 text-lg dark:text-zinc-200">0</p>
</Example>
...
<Example>
  <p class="font-source lining-nums text-center text-zinc-900 text-lg dark:text-zinc-200">1234567890</p>
</Example>
...
<Example>
  <p class="font-source oldstyle-nums text-center text-zinc-900 text-lg dark:text-zinc-200">1234567890</p>
</Example>
...
<Example>
  <div class="max-w-sm text-right">
    <p class="font-source proportional-nums text-zinc-900 text-lg dark:text-zinc-200">12121</p>
    <p class="font-source proportional-nums text-zinc-900 text-lg dark:text-zinc-200">90909</p>
  </div>
</Example>
...
<Example>
  <div class="max-w-sm text-right">
    <p class="font-source tabular-nums text-zinc-900 text-lg dark:text-zinc-200">12121</p>
    <p class="font-source tabular-nums text-zinc-900 text-lg dark:text-zinc-200">90909</p>
  </div>
</Example>
...
<Example>
  <p class="font-source diagonal-fractions text-center text-zinc-900 text-lg dark:text-zinc-200">1/2 3/4 5/6</p>
</Example>
...
<Example>
  <p class="font-ubuntu-mono stacked-fractions text-center text-zinc-900 text-lg dark:text-zinc-200">1/2 3/4 5/6</p>
</Example>
