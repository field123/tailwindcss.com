...
<Example>
  <div class="flex justify-center">
    <div class="space-y-4 font-mono font-bold text-xs text-center text-white">
      <div class="px-4 py-2 bg-zinc-500 rounded-lg shadow-lg w-96 hidden sm:block">w-96</div>
      <div class="px-4 py-2 bg-zinc-500 rounded-lg shadow-lg w-80 hidden sm:block">w-80</div>
      <div class="px-4 py-2 bg-zinc-500 rounded-lg shadow-lg w-64 hidden sm:block">w-64</div>
      <div class="px-4 py-2 bg-zinc-500 rounded-lg shadow-lg w-48">w-48</div>
      <div class="px-4 py-2 bg-zinc-500 rounded-lg shadow-lg w-40">w-40</div>
      <div class="px-4 py-2 bg-zinc-500 rounded-lg shadow-lg w-32">w-32</div>
      <div class="px-4 py-2 bg-zinc-500 rounded-lg shadow-lg w-24">w-24</div>
    </div>
  </div>
</Example>
