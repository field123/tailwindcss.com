...
<Example>
  <div class="flex flex-col sm:flex-row items-center justify-center space-y-10 sm:space-y-0 sm:space-x-10">
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">bg-clip-border</p>
    ...
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">bg-clip-padding</p>
    ...
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">bg-clip-content</p>
