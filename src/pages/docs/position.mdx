...
<Example>
  <div class="relative text-sm font-medium leading-6">
    <div class="bg-sky-400/20 border border-sky-700/10 rounded-lg p-4 dark:bg-zinc-900/70 dark:border-0">
      <div class="relative bg-sky-400/20 border border-sky-700/10 p-4 h-32 dark:bg-zinc-400/20 dark:border-0">
        <p class="text-sky-700 dark:text-white">Relative parent</p>
        <div class="absolute bottom-0 left-0 bg-sky-500 shadow-lg rounded-lg p-4 text-white dark:bg-zinc-500">
          <p>Absolute child</p>
        </div>
      </div>
    </div>
