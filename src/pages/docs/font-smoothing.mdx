...
<Example>
  <div class="flex flex-col gap-8">
    <div>
      <span class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">subpixel-antialiased</span>
      <p class="subpixel-antialiased text-lg font-medium text-zinc-900 dark:text-zinc-200">
        The quick brown fox jumps over the lazy dog.
      </p>
    </div>
    <div>
      <span class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">antialiased</span>
      <p class="antialiased text-lg font-medium text-zinc-900 dark:text-zinc-200">
        The quick brown fox jumps over the lazy dog.
      </p>
    </div>
  </div>
