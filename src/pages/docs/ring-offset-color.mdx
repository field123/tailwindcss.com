...
<Example>
  <div class="grid place-content-center text-white text-sm text-center font-bold leading-6">
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm font-mono text-zinc-500 text-center mb-3 dark:text-zinc-400">ring-offset-purple-100</p>
      <button class="px-4 py-2 font-semibold text-sm bg-white text-zinc-700 border border-zinc-300 rounded-md shadow-sm ring-2 ring-offset-4 ring-offset-purple-100 ring-purple-500 dark:bg-zinc-700 dark:text-zinc-200 dark:border-transparent">Save Changes</button>
    </div>
  </div>
</Example>
...
<HoverFocusAndOtherStates defaultClass="ring-2 ring-offset-2 ring-offset-zinc-300" featuredClass="ring-offset-zinc-500" />

### <Heading ignore>Breakpoints and media queries</Heading>

<BreakpointsAndMediaQueries defaultClass="ring-2 ring-offset-2 ring-offset-zinc-300" featuredClass="ring-offset-zinc-500" />
