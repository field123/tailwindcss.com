...
<Example p="none" lightOnly={true}>
  ...
  <div class="flex items-center justify-around gap-12 font-mono font-bold shrink-0 p-8">
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3">shadow-md</p>
      <div class="w-24 h-24 rounded-lg bg-white shadow-md"></div>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3">shadow-lg</p>
      <div class="w-24 h-24 rounded-lg bg-white shadow-lg"></div>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3">shadow-xl</p>
      <div class="w-24 h-24 rounded-lg bg-white shadow-xl"></div>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3">shadow-2xl</p>
...
<Example lightOnly={true}>
  <div class="flex items-center justify-around gap-4 font-mono font-bold">
    <div class="flex flex-col items-center">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3">shadow-inner</p>
...
<Example lightOnly={true}>
  <div class="flex items-center justify-around gap-4 font-mono font-bold">
    <div class="flex flex-col items-center">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3">shadow-none</p>
