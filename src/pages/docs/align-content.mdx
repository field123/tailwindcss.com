...
<Example>
  <div class="font-mono text-white text-sm font-bold leading-6">
    <div class="grid grid-cols-3 gap-4 content-center w-full rounded-lg bg-stripes-blue text-center h-56">
...
<Example>
  <div class="font-mono text-white text-sm font-bold leading-6">
    <div class="grid grid-cols-3 gap-x-4 content-around w-full rounded-lg bg-stripes-zinc text-center h-56">
      <div class="p-4 shadow-lg rounded-lg bg-zinc-500">01</div>
      <div class="p-4 shadow-lg rounded-lg bg-zinc-500">02</div>
      <div class="p-4 shadow-lg rounded-lg bg-zinc-500">03</div>
      <div class="p-4 shadow-lg rounded-lg bg-zinc-500">04</div>
      <div class="p-4 shadow-lg rounded-lg bg-zinc-500">05</div>
    </div>
  </div>
</Example>
