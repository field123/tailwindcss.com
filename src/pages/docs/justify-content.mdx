...
<Example>
  <div class="flex justify-center space-x-4 font-mono text-white text-sm font-bold leading-6 bg-stripes-zinc rounded-lg">
    <div class="w-14 h-14 rounded-lg flex items-center justify-center bg-zinc-500 shadow-lg">01</div>
    <div class="w-14 h-14 rounded-lg flex items-center justify-center bg-zinc-500 shadow-lg">02</div>
    <div class="w-14 h-14 rounded-lg flex items-center justify-center bg-zinc-500 shadow-lg">03</div>
  </div>
</Example>
