...
<Example>
  <div class="w-full mx-auto max-w-xl bg-white dark:bg-zinc-800 dark:ring-1 dark:ring-zinc-200/20 h-80 bg-repeat bg-center shadow-xl rounded-lg" style="background-image:url('/img/background-pattern.svg');">
  </div>
</Example>
...
<Example>
  <div class="w-full mx-auto max-w-xl bg-white dark:bg-zinc-800 dark:ring-1 dark:ring-zinc-200/20 h-64 bg-no-repeat bg-center shadow-xl rounded-lg" style="background-image:url('/img/background-pattern.svg');">
  </div>
</Example>
...
<Example>
  <div class="w-full mx-auto max-w-xl bg-white dark:bg-zinc-800 dark:ring-1 dark:ring-zinc-200/20 h-64 bg-repeat-x bg-center shadow-xl rounded-lg" style="background-image:url('/img/background-pattern.svg');">
  </div>
</Example>
...
<Example>
  <div class="w-full mx-auto max-w-xl bg-white dark:bg-zinc-800 dark:ring-1 dark:ring-zinc-200/20 h-64 bg-repeat-y bg-center shadow-xl rounded-lg" style="background-image:url('/img/background-pattern.svg');">
  </div>
</Example>
