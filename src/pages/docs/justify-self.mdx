...
<Example>
  <div class="grid grid-cols-3 gap-4 justify-items-stretch auto-rows-fr font-mono text-white text-sm font-bold leading-6 text-center">
    <div class="p-4 rounded-lg bg-zinc-300 dark:bg-zinc-800 dark:text-zinc-500">01</div>
    <div class="justify-self-end grid w-full bg-stripes-zinc rounded-lg">
      <div class="justify-self-end p-4 w-14 h-14 rounded-lg bg-zinc-500 shadow-lg">02</div>
    </div>
    <div class="p-4 rounded-lg bg-zinc-300 dark:bg-zinc-800 dark:text-zinc-500">03</div>
    <div class="p-4 rounded-lg bg-zinc-300 dark:bg-zinc-800 dark:text-zinc-500">04</div>
    <div class="p-4 rounded-lg bg-zinc-300 dark:bg-zinc-800 dark:text-zinc-500">05</div>
    <div class="p-4 rounded-lg bg-zinc-300 dark:bg-zinc-800 dark:text-zinc-500">06</div>
  </div>
</Example>
