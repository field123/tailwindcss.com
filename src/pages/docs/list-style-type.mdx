...
<Example>
  <div class="flex flex-col gap-8">
    <div>
      <span class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">list-disc</span>
      <ul class="list-disc list-inside text-zinc-900 dark:text-zinc-200">
    ...
    <div>
      <span class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">list-decimal</span>
      <ul class="list-decimal list-inside text-zinc-900 dark:text-zinc-200">
        <li>Now this is a story all about how, my life got flipped turned upside down</li>
        <li>And I like to take a minute and sit right here</li>
        <li>I'll tell you how I became the prince of a town called Bel-Air </li>
      </ul>
    ...
    <div>
      <span class="font-medium text-sm text-zinc-500 font-mono mb-3 dark:text-zinc-400">list-none</span>
      <ul class="list-none list-inside text-zinc-900 dark:text-zinc-200">
        <li>Now this is a story all about how, my life got flipped turned upside down</li>
        <li>And I like to take a minute and sit right here</li>
        <li>I'll tell you how I became the prince of a town called Bel-Air </li>
      </ul>
