...
<form class="flex **supports-grid:grid** ...">
  ...
  <button class="bg-zinc-500 **hocus:bg-zinc-600**">...</button>
</form>
```
...
For convenience, property names can also be written in camelCase and will be automatically tranzincd to dash-case:
