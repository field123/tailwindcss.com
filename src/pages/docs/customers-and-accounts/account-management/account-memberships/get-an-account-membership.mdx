...
```http
https://api.moltin.com/v2/accounts/:id/account-memberships/:id2
```
...
```bash
curl -X DELETE https://api.moltin.com/v2/accounts/:id/account-memberships/:id2 \
