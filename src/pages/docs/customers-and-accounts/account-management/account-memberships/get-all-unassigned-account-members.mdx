---
id: get-all-unassigned-account-members
title: Get All Unassigned Account Members
sidebar_label: Get All Unassigned Account Members
---
...
| Name | Required | Type | Description |
 | --- | --- | --- | --- |
| `filter` | Optional | `string` | Filter attributes. For more information, see the [Filtering unassigned account members](#filtering) section. |
...
The following operators and attributes are available for [filtering](../../../basics/filtering.md) unassigned account members.
...
:::note
You can use [pagination](../../../basics/pagination.md) with this resource.
:::
