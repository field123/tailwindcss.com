---
id: update-an-account-membership
title: Update an Account Membership
sidebar_label: Update an Account Membership
---

You can update and extend an account member details using [core flows](../../../advanced/custom-data/index.md#extend-a-resource). However, you cannot update the `account_member_id` of an account member.
...
```bash
curl -X PUT https://api.moltin.com/v2/accounts/:accountId/account-memberships/:membershipId/ \
