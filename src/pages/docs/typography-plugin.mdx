...
```html
<article class="prose **prose-img:rounded-xl** **prose-headings:underline** **prose-a:text-zinc-600**">
  {{ markdown }}
</article>
```
...
```html
<article class="prose prose-a:text-zinc-600 **hover:prose-a:text-zinc-500**">
  {{ markdown }}
</article>
```
...
```html
<article class="wysiwyg wysiwyg-zinc lg:wysiwyg-xl">
  <h1>My Heading</h1>
  <p>...</p>
