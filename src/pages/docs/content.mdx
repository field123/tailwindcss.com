...
<Example p="none">
  <div class="px-4 sm:px-0">
    <div class="p-8 w-full max-w-xl mx-auto bg-white shadow-lg text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400">
      Higher resolution means more than just a better-quality image. With a Retina 6K display, <a href="https://www.apple.com/pro-display-xdr/" class="text-zinc-600 dark:text-sky-400 font-medium after:content-['_↗'] after:text-sm after:font-bold" target="_blank">Pro Display XDR</a> gives you nearly 40 percent more screen real estate than a 5K display.
    </div>
  </div>
</Example>
...
6K display, <a class="text-zinc-600 **after:content-['_↗']** ..." dark-class="text-sky-400 **after:content-['_↗']** ..." href="https://www.
