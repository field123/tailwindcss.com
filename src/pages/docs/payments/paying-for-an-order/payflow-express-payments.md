---
id: payflow-express-payments
title: PayPal Payflow Pro Payments
sidebar_label: PayPal Payflow Pro (Express Checkout)
---

The PayPal Payflow Pro integration supports the following payment methods:
...
## Step 1: `POST` Initialize the payment
...
| `gateway` | Required | `string` | Use the value `payflow_express`. |
| `options.return_url` | Required | `string` | The callback URL for PayPal to redirect the user in the case of approved payment. |
| `options.cancel_return_url` | Required | `string` | The callback URL for PayPal to redirect the user in the case of a cancelled payment. |
...
## Step 2: `POST` Authorize the payment
...
| Name | Required | Type | Description |
| --- | --- | --- | --- |
| `orderId` | Required | `string` | The Universally Unique Identifier (UUID) of the order the you want to pay for. |
...
| Name | Required | Type | Description |
| --- | --- | --- | --- |
| `method` | Required | `string` | The method value, such as `authorize`. |
| `gateway` | Required | `string` | Use the value `payflow_express`. |
...
Use this endpoint to capture a transaction initiated by a shopper. Usually capture does not occur at the same time as authorization. For more information, see the [Capture](./index.md#capture) section.
