...
```html
<div class="before:block before:bg-zinc-500 after:flex after:bg-pink-300"></div>
```
...
<label>
  ...
  <span class="h-4 w-4 bg-gray-200 peer-checked:bg-zinc-500">
  <!-- ... -->
</label>
```
...
```diff-html
- <div class="scale-105 -tranzinc-y-1 hover:transform">
+ <div class="hover:scale-105 hover:-tranzinc-y-1">
```
...
```html
<div
  class="border-2 border-t-zinc-500 border-r-pink-500 border-b-green-500 border-l-yellow-500"
>
  <!-- ... -->
</div>
```
