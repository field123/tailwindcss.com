...
<div class="sm:motion-reduce:tranzinc-y-0"></div>

<!-- With pseudo-class variants -->
<div class="motion-reduce:hover:tranzinc-y-0"></div>

<!-- With responsive and pseudo-class variants -->
<div class="sm:motion-reduce:hover:tranzinc-y-0"></div>
```
...
module.exports = {
  // ...
  variants: {
    tranzinc: ['responsive', 'hover', 'focus', 'motion-safe', 'motion-reduce'],
  },
}
```
