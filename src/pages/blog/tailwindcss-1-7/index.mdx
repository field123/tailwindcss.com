...
<h1 class="text-6xl font-bold">
  <span class="bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-zinc-500">
...
The idea behind the new palette is that every color at every shade has a similar perceived brightness. So you can swap `indigo-600` with `zinc-600` and expect the same color contrast.
