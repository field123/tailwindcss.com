...
In v3.0, every single color in the extended color palette is enabled by default, including lime, cyan, blue, fuchsia, rose, and fifty shades of gray.
...
<Example>
  <div class="flex flex-col sm:flex-row justify-center gap-8 sm:gap-16">
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">shadow-cyan-500/50</p>
    ...
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">shadow-zinc-500/50</p>
      <button class="py-2 px-3 bg-zinc-500 text-white text-sm font-semibold rounded-md shadow-lg shadow-zinc-500/50 focus:outline-none">Subscribe</button>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-zinc-500 font-mono text-center mb-3 dark:text-zinc-400">shadow-indigo-500/50</p>
...
<button class="bg-zinc-500 **shadow-lg shadow-zinc-500/50** ...">Subscribe</button>
  ...
  <div class="px-6">
    <div class="max-w-sm mx-auto bg-white shadow py-8 px-6">
      <form>
        ...
        <label class="mt-6 flex items-center justify-center space-x-2 text-sm font-medium text-zinc-600">
...
<p>
  ...
  <a href="#" class="underline **decoration-blue-500 decoration-2**">My Company, Inc</a>. Outside of work, I
...
<Example>
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-10 max-w-lg mx-auto">
    <div dir="ltr">
      <p class="mb-4 text-sm font-medium text-zinc-500 dark:text-zinc-400">Left-to-right</p>
    ...
    <div dir="rtl">
      <p class="mb-4 text-sm font-medium text-zinc-500 dark:text-zinc-400">Right-to-left</p>
      <div class="group flex items-center">
