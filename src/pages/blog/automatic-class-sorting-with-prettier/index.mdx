...
```html HTML
<!-- Before -->
<button class="text-white px-4 sm:px-8 py-2 sm:py-3 bg-blue-700 hover:bg-blue-800">...</button>

<!-- After -->
<button class="bg-blue-700 px-4 py-2 text-white hover:bg-blue-800 sm:px-8 sm:py-3">...</button>
```
