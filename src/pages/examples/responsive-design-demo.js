export default function ReponsiveDesignDemo() {
  return (
    <div className="flex items-center justify-center p-8 w-screen h-screen">
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-xl overflow-hidden sm:max-w-2xl ring-1 ring-zinc-900/5">
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="p-6 2xl:p-8 space-y-2">
            ...
            <a
              href="#"
              className="block font-semibold text-base text-zinc-900 leading-6 hover:underline"
            >
