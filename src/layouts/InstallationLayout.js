...
let readNext = [
  ...
  },
  {
    ...
    icon: {
      className: 'dark:bg-zinc-600 dark:highlight-white/20',
  ...
  return (
    <BasicLayout>
      ...
      <section className="mb-16 relative">
        <div className="relative z-10">
          <h2
            ...
            className="text-zinc-900 text-xl tracking-tight font-bold mb-3 dark:text-zinc-200"
          >
            Installation
          </h2>
          <div className="flex overflow-auto mb-6 -mx-4 sm:-mx-6">
            <div className="flex-none min-w-full px-4 sm:px-6">
              <ul className="border-b border-zinc-200 space-x-6 flex whitespace-nowrap dark:border-zinc-200/5">
      ...
      <section className="relative">
        <h2 className="text-zinc-900 text-xl tracking-tight font-bold mb-3 dark:text-zinc-200">
          What to read next
        </h2>
        <div className="mb-10 max-w-2xl prose prose-zinc xl:mb-0 dark:prose-dark">
          <p>
          ...
          {readNext.map((item) => (
            <li key={item.title} className="relative flex items-start">
              ...
              <div className="peer group flex-auto ml-6">
                ...
                <div className="prose prose-zinc prose-sm text-zinc-600 dark:prose-dark">
                  <item.body />
                </div>
              </div>
