  ...
  return (
    ...
    >
      <path
        ...
        className={
          selected ? 'fill-blue-400/20 stroke-blue-500' : 'stroke-zinc-400 dark:stroke-zinc-500'
        }
      />
      <path
        d="M12 4v1M17.66 6.344l-.828.828M20.005 12.004h-1M17.66 17.664l-.828-.828M12 20.01V19M6.34 17.664l.835-.836M3.995 12.004h1.01M6 6l.835.836"
        className={selected ? 'stroke-blue-500' : 'stroke-zinc-400 dark:stroke-zinc-500'}
      />
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        ...
        className={selected ? 'fill-blue-400/20' : 'fill-transparent'}
      />
      <path
        d="m17.715 15.15.95.316a1 1 0 0 0-1.445-1.185l.495.869ZM9 6.035l.846.534a1 1 0 0 0-1.14-1.49L9 6.035Zm8.221 8.246a5.47 5.47 0 0 1-2.72.718v2a7.47 7.47 0 0 0 3.71-.98l-.99-1.738Zm-2.72.718A5.5 5.5 0 0 1 9 9.5H7a7.5 7.5 0 0 0 7.5 7.5v-2ZM9 9.5c0-1.079.31-2.082.845-2.93L8.153 5.5A7.47 7.47 0 0 0 7 9.5h2Zm-4 3.368C5 10.089 6.815 7.75 9.292 6.99L8.706 5.08C5.397 6.094 3 9.201 3 12.867h2Zm6.042 6.136C7.718 19.003 5 16.268 5 12.867H3c0 4.48 3.588 8.136 8.042 8.136v-2Zm5.725-4.17c-.81 2.433-3.074 4.17-5.725 4.17v2c3.552 0 6.553-2.327 7.622-5.537l-1.897-.632Z"
        className={selected ? 'fill-blue-500' : 'fill-zinc-400 dark:fill-zinc-500'}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        ...
        strokeLinejoin="round"
        className={
          selected ? 'stroke-blue-500 fill-blue-400/20' : 'stroke-zinc-400 dark:stroke-zinc-500'
        }
      />
      <path
...
export function ThemeSelect() {
  ...
  return (
    <div className="flex items-center justify-between">
      <label htmlFor="theme" className="text-zinc-700 font-normal dark:text-zinc-400">
        Switch theme
      </label>
      <div className="relative flex items-center ring-1 ring-zinc-900/10 rounded-lg shadow-sm p-2 text-zinc-700 font-semibold dark:bg-zinc-600 dark:ring-0 dark:highlight-white/5 dark:text-zinc-200">
        ...
        {label}
        <svg className="w-6 h-6 ml-2 text-zinc-400" fill="none">
          <path
            d="m15 11-3 3-3-3"
            stroke="currentColor"
            strokeWidth="2"
