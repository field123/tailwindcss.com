  ...
  return (
    ...
    >
      <path
        ...
        className={
          selected ? 'fill-sky-400/20 stroke-sky-500' : 'stroke-zinc-400 dark:stroke-zinc-500'
        }
      />
      <path
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        ...
        strokeLinejoin="round"
        className={
          selected ? 'stroke-sky-500 fill-sky-400/20' : 'stroke-zinc-400 dark:stroke-zinc-500'
        }
      />
      <path
