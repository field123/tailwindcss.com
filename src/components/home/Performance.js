      ...
      <GridLockup
        ...
        left={
          <div className="relative">
            <div
              ref={containerRef}
              className="relative bg-zinc-800 shadow-xl pt-2 overflow-hidden sm:rounded-xl lg:grid lg:grid-cols-2 lg:grid-rows-1 dark:bg-zinc-900/70 dark:backdrop-blur dark:ring-1 dark:ring-inset dark:ring-white/10"
            >
              <div className="row-end-1">
                ...
                <CodeWindow.Code2
                  ...
                  overflow={false}
                  className="border-r border-zinc-500/30 h-[20.8125rem] overflow-hidden p-4 md:pl-0"
                >
                  {html.map((tokens, lineIndex) => (
                    <div key={lineIndex} className="flex">
                      <div className="hidden md:block text-zinc-600 flex-none pr-4 text-right select-none w-[3.125rem] mr-4">
                        {lineIndex + 1}
                      </div>
                      <div>
                          ...
                          if (token.content === '__CLASSES__') {
                            return (
                              ...
                              >
                                {active && (
                                  <Typing
                                    classes="flex items-center px-4 py-3 text-white bg-zinc-500 hover:bg-zinc-400"
                                    rules={rules}
              ...
              <div className="row-span-2 border-t border-zinc-500/30 pt-1.5 lg:border-0 lg:pt-0">
                <TabBar
                  side="right"
                  translucent={true}
              ...
              <div className="row-start-1 row-end-2 border-t border-zinc-500/30">
                <div className="h-1.5 border-r border-zinc-500/30" />
                <TabBar
                  side="right"
                  translucent={true}
...
function Terminal({ rules }) {
  ...
  return (
    <div
      ref={scrollRef}
      className="flex-auto border-r border-zinc-500/30 text-zinc-400 font-mono p-4 pb-0 h-[8.75rem] overflow-hidden scroll-smooth flex"
    >
      ...
      <pre className="flex-auto leading-6 text-sm">
        <code className="block space-y-1 pb-4">
          ...
          {rules.map((_rule, index) => (
            <div key={index} className={index === rules.length - 1 ? 'text-zinc-200' : undefined}>
