      ...
      {typed && (
        <span className="relative z-10">
          <div className="absolute top-full left-full m-0.5 -ml-16 sm:ml-0.5 rounded-lg shadow-xl">
            <div className="relative w-96 bg-zinc-700 overflow-hidden rounded-lg">
                  ...
                  .map((completion, i) => (
                    <li
                      ...
                      className={clsx('px-3 flex items-center space-x-2', {
                        'bg-zinc-600': i === selectedCompletionIndex,
                      })}
                    >
                      <span className="w-5 flex-none flex justify-center">
                        {completion[2] ? (
                          <span
                            className="flex-none w-3 h-3 rounded ring-1 ring-zinc-900/30"
                      ...
                      <span className="flex-none !text-zinc-50">
                      ...
                      {i === selectedCompletionIndex && completion[1] ? (
                        <span className="hidden sm:block flex-auto text-right !text-zinc-400 truncate pl-4">
                          {completion[1]}
                        </span>
                      ) : null}
                    </li>
...
function ColorDecorator({ color }) {
  return (
    <span
      className="inline-flex w-3 h-3 rounded ring-1 ring-zinc-900/30 relative top-px mr-1"
  ...
  return (
    <section id="editor-tools">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        />
        <Caption className="text-blue-500">Editor tools</Caption>
        ...
        <Link href="/docs/intellisense" color="blue" darkColor="gray">
          ...
          <div className="relative">
            ...
            <CodeWindow className="!h-[39.0625rem]">
              <div className="flex-auto flex min-h-0">
                <div className="hidden sm:flex flex-none w-14 border-r border-zinc-500/30 flex-col items-center justify-between pt-3.5 pb-4">
                ...
                <div className="flex-auto flex flex-col min-w-0">
                  <CompletionDemo />
                  <div className="border-t border-zinc-500/30 font-mono text-xs leading-6 text-zinc-200 p-4 space-y-2">
                    <h3>Problems</h3>
                    <ul className="space-y-1 text-zinc-300">
                      {problems.map((problem, i) => (
                        <li key={i} className="flex min-w-0">
                          ...
                          <p className="hidden sm:block flex-none text-zinc-500">
                            &nbsp;{problem[1]}
                          </p>
                        </li>
                      ))}
