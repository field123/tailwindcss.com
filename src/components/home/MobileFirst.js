...
function BrowserWindow({ size, onChange }) {
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="sm:rounded-xl ring-1 ring-zinc-900/5">
          <div className="sm:rounded-t-xl bg-gradient-to-b from-white to-[#FBFBFB] dark:bg-none dark:bg-zinc-700 dark:highlight-white/10">
            <div
              className={clsx(
            ...
            >
                ...
                {size !== undefined && (
                  <>
                    <svg
                      ...
                      height="24"
                      fill="none"
                      className="ml-4 flex-none text-zinc-400 dark:text-zinc-500"
                    >
                      <path
                        d="m15 7-5 5 5 5"
                        stroke="currentColor"
                    ...
                    <svg
                      ...
                      height="24"
                      fill="none"
                      className="ml-2 flex-none text-zinc-400 dark:text-zinc-500"
                    >
                      <path
                        d="m10 7 5 5-5 5"
                        stroke="currentColor"
              ...
              <div>
                <div className="bg-zinc-100 rounded-md font-medium text-xs leading-6 py-1 flex items-center justify-center ring-1 ring-inset ring-zinc-900/5 mx-auto w-4/5 dark:bg-zinc-800 dark:text-zinc-500">
                  <svg
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    className="text-zinc-300 w-3.5 h-3.5 mr-1.5 dark:text-zinc-500"
                  >
                    <path
                      fillRule="evenodd"
            ...
            <div className="grid grid-cols-3 text-xs leading-5 overflow-hidden">
              <div className="pointer-events-none select-none bg-zinc-100 text-zinc-400 rounded-tr border border-zinc-900/5 px-4 py-1.5 -mb-px -ml-px flex items-center justify-center space-x-2 dark:bg-zinc-800 dark:text-zinc-500">
                <svg
                  width="17"
                  height="10"
                  fill="currentColor"
                  className="flex-none text-zinc-300 dark:text-zinc-500"
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
              ...
              <div className="pointer-events-none select-none text-zinc-900 font-medium px-4 py-1.5 flex items-center justify-center space-x-2 dark:text-zinc-200">
                <svg
                  width="15"
                  height="14"
                  fill="currentColor"
                  className="flex-none text-indigo-600 dark:text-zinc-400"
                >
              ...
              <div className="pointer-events-none select-none bg-zinc-100 text-zinc-400 rounded-tl border border-zinc-900/5 pl-4 pr-8 py-1.5 -mb-px -mr-4 flex items-center justify-center space-x-2 dark:bg-zinc-800 dark:text-zinc-500">
                <svg
                  width="15"
                  height="16"
                  fill="currentColor"
          ...
          <div className="relative bg-white border-t border-zinc-200 rounded-b-xl pb-8 -mb-8 dark:bg-zinc-800 dark:border-zinc-900/50">
            <motion.iframe
              ref={iframeRef}
      ...
      >
        ...
        >
          <div className="w-1.5 h-8 bg-zinc-500/60 rounded-full" />
        </motion.div>
      </div>
    </div>
  )
  ...
  return (
    <div className={clsx('flex items-start flex-none', className)}>
      <div className="flex flex-col items-center ml-[-2px]">
        <div
          className={clsx('w-px h-14', active ? 'bg-indigo-600' : 'bg-zinc-100 dark:bg-zinc-800')}
        />
        <div
          className={clsx(
            ...
            active
              ...
              : 'bg-white ring-zinc-500/[0.15] dark:bg-zinc-900 dark:ring-zinc-700'
          )}
        />
      </div>
      <div
        className={clsx(
          ...
          active
            ...
            : 'bg-zinc-100 ring-zinc-100 dark:bg-zinc-800 dark:highlight-white/5'
        )}
      >
        {label}
      </div>
...
export function MobileFirst() {
  ...
  return (
    <section id="mobile-first" className="overflow-hidden">
      ...
      <div className="hidden mt-16 mb-12 border-b border-zinc-100 xl:mb-0 demo-sm:block dark:border-zinc-800">
