...
const code = {
  ...
  <form class="flex-auto p-6">
    <div class="flex flex-wrap">
      <h1 class="flex-auto text-lg font-semibold text-zinc-900">Classic Utility Jacket</h1>
      <div class="text-lg font-semibold text-zinc-500">$110.00</div>
      <div class="w-full flex-none text-sm font-medium text-zinc-700 mt-2">In stock</div>
    </div>
    <div class="flex items-baseline mt-4 mb-6 pb-6 border-b border-zinc-200">
      <div class="space-x-2 flex text-sm">
        <label>
          <input class="sr-only peer" name="size" type="radio" value="xs" checked />
          <div class="w-9 h-9 rounded-lg flex items-center justify-center text-zinc-700 peer-checked:font-semibold peer-checked:bg-zinc-900 peer-checked:text-white">XS</div>
        </label>
        <label>
          <input class="sr-only peer" name="size" type="radio" value="s" />
          <div class="w-9 h-9 rounded-lg flex items-center justify-center text-zinc-700 peer-checked:font-semibold peer-checked:bg-zinc-900 peer-checked:text-white">S</div>
        </label>
        <label>
          <input class="sr-only peer" name="size" type="radio" value="m" />
          <div class="w-9 h-9 rounded-lg flex items-center justify-center text-zinc-700 peer-checked:font-semibold peer-checked:bg-zinc-900 peer-checked:text-white">M</div>
        </label>
        <label>
          <input class="sr-only peer" name="size" type="radio" value="l" />
          <div class="w-9 h-9 rounded-lg flex items-center justify-center text-zinc-700 peer-checked:font-semibold peer-checked:bg-zinc-900 peer-checked:text-white">L</div>
        </label>
        <label>
          <input class="sr-only peer" name="size" type="radio" value="xl" />
          <div class="w-9 h-9 rounded-lg flex items-center justify-center text-zinc-700 peer-checked:font-semibold peer-checked:bg-zinc-900 peer-checked:text-white">XL</div>
        </label>
      </div>
    </div>
    <div class="flex space-x-4 mb-6 text-sm font-medium">
      <div class="flex-auto flex space-x-4">
        ...
        <button class="h-10 px-6 font-semibold rounded-md border border-zinc-200 text-zinc-900" type="button">Add to bag</button>
      </div>
      <button class="flex-none flex items-center justify-center w-9 h-9 rounded-md text-zinc-300 border border-zinc-200" type="button" aria-label="Like">
        <svg width="20" height="20" fill="currentColor" aria-hidden="true">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" />
        </svg>
      </button>
    </div>
    <p class="text-sm text-zinc-700">Free shipping on all continental US orders.</p>
  </form>
</div>`,
  ...
  <form class="flex-auto p-6">
    <div class="flex flex-wrap">
      <h1 class="flex-auto font-medium text-zinc-900">Classic Utility Jacket</h1>
      <div class="w-full flex-none mt-2 order-1 text-3xl font-bold text-violet-600">$110.00</div>
      <div class="text-sm font-medium text-zinc-400">In stock</div>
    </div>
    <div class="flex items-baseline mt-4 mb-6 pb-6 border-b border-zinc-200">
    ...
    <div class="flex space-x-4 mb-5 text-sm font-medium">
      <div class="flex-auto flex space-x-4">
        ...
        <button class="h-10 px-6 font-semibold rounded-full border border-zinc-200 text-zinc-900" type="button">Add to bag</button>
      </div>
    ...
    <p class="text-sm text-zinc-500">Free shipping on all continental US orders.</p>
  </form>
</div>`,
  ...
  <form class="flex-auto p-6">
    <div class="flex flex-wrap items-baseline">
      <h1 class="w-full flex-none mb-3 text-2xl leading-none text-zinc-900">Classic Utility Jacket</h1>
      <div class="flex-auto text-lg font-medium text-zinc-500">$350.00</div>
      <div class="text-xs leading-6 font-medium uppercase text-zinc-500">In stock</div>
    </div>
    <div class="flex items-baseline mt-4 mb-6 pb-6 border-b border-zinc-200">
      <div class="space-x-1 flex text-sm font-medium">
        <label>
          <input class="sr-only peer" name="size" type="radio" value="xs" checked />
          <div class="w-7 h-7 rounded-full flex items-center justify-center text-zinc-500 peer-checked:bg-zinc-100 peer-checked:text-zinc-900">XS</div>
        </label>
        <label>
          <input class="sr-only peer" name="size" type="radio" value="s" />
          <div class="w-7 h-7 rounded-full flex items-center justify-center text-zinc-500 peer-checked:bg-zinc-100 peer-checked:text-zinc-900">S</div>
        </label>
        <label>
          <input class="sr-only peer" name="size" type="radio" value="m" />
          <div class="w-7 h-7 rounded-full flex items-center justify-center text-zinc-500 peer-checked:bg-zinc-100 peer-checked:text-zinc-900">M</div>
        </label>
        <label>
          <input class="sr-only peer" name="size" type="radio" value="l" />
          <div class="w-7 h-7 rounded-full flex items-center justify-center text-zinc-500 peer-checked:bg-zinc-100 peer-checked:text-zinc-900">L</div>
        </label>
        <label>
          <input class="sr-only peer" name="size" type="radio" value="xl" />
          <div class="w-7 h-7 rounded-full flex items-center justify-center text-zinc-500 peer-checked:bg-zinc-100 peer-checked:text-zinc-900">XL</div>
        </label>
      </div>
    </div>
    <div class="flex space-x-4 mb-5 text-sm font-medium">
      <div class="flex-auto flex space-x-4 pr-4">
        <button class="flex-none w-1/2 h-12 uppercase font-medium tracking-wider bg-zinc-900 text-white" type="submit">Buy now</button>
        <button class="flex-none w-1/2 h-12 uppercase font-medium tracking-wider border border-zinc-200 text-zinc-900" type="button">Add to bag</button>
      </div>
      <button class="flex-none flex items-center justify-center w-12 h-12 text-zinc-300 border border-zinc-200" type="button" aria-label="Like">
        <svg width="20" height="20" fill="currentColor" aria-hidden="true">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" />
        </svg>
      </button>
  ...
  <form class="flex-auto pl-6">
    ...
    <div class="flex space-x-2 mb-4 text-sm font-medium">
      <div class="flex space-x-4">
        ...
        <button class="px-6 h-12 uppercase font-semibold tracking-wider border border-zinc-200 text-zinc-900" type="button">Add to bag</button>
      </div>
    ...
    <p class="text-xs leading-6 text-zinc-500">Free shipping on all continental US orders.</p>
  </form>
</div>`,
}
