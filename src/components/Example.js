  ...
  return (
    <div className={containerClassName}>
      ...
      <Component
        style={style}
        className={clsx(
          'not-prose relative bg-zinc-50 rounded-xl overflow-hidden',
          !lightOnly && 'dark:bg-zinc-800/25'
        )}
      >
        <div
          style={{ backgroundPosition: '10px 10px' }}
          className={clsx(
            'absolute inset-0 bg-grid-zinc-100 [mask-image:linear-gradient(0deg,#fff,rgba(255,255,255,0.6))]',
            !lightOnly &&
              'dark:bg-grid-zinc-700/25 dark:[mask-image:linear-gradient(0deg,rgba(255,255,255,0.1),rgba(255,255,255,0.5))]'
          )}
        />
        <div
