...
export function Cta({ description, href, label }) {
  return (
    <p className="flex flex-wrap sm:flex-nowrap lg:flex-wrap xl:flex-nowrap items-center py-6 px-4 sm:p-6 lg:p-10 ring-1 ring-zinc-900/5 shadow rounded-lg dark:bg-zinc-800 dark:shadow-none dark:ring-0 dark:highlight-white/5">
      <span className="flex-auto flex items-start mb-8 sm:mb-0 lg:mb-8 xl:mb-0">
        ...
        <span className="flex-auto text-sm leading-6 text-zinc-600 xl:max-w-2xl dark:text-zinc-400">
          {description}
        </span>
      </span>
      <span className="flex-none flex justify-center w-full sm:w-auto sm:ml-6 md:ml-8 lg:w-full lg:ml-0 xl:w-auto xl:ml-8">
        <Button href={href} darkColor="blue">
          {label}
        </Button>
      </span>
    </p>
