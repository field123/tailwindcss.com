  ...
  return (
    <Component
      className={clsx('group flex whitespace-pre-wrap', className, {
        '-ml-4 pl-4': !hidden,
        'mb-2 text-sm leading-6 text-blue-500 font-semibold tracking-normal dark:text-blue-800':
    ...
    >
      {!hidden && (
        ...
        >
          &#8203;
          <div className="w-6 h-6 text-zinc-400 ring-1 ring-zinc-900/5 rounded-md shadow-sm flex items-center justify-center hover:ring-zinc-900/10 hover:shadow hover:text-zinc-700 dark:bg-zinc-700 dark:text-zinc-300 dark:shadow-none dark:ring-0">
