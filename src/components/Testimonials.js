...
function Testimonial({ author, content, url, expanded }) {
  ...
  return (
    <li ref={ref} className="text-sm leading-6">
      <figure className="relative flex flex-col-reverse bg-zinc-50 rounded-lg p-6 dark:bg-zinc-800 dark:highlight-white/5">
        <blockquote className="mt-6 text-zinc-700 dark:text-zinc-300">
        ...
        <figcaption className="flex items-center space-x-4">
          ...
          <div className="flex-auto">
            <div className="text-base text-zinc-900 font-semibold dark:text-zinc-300">
              {url ? (
...
export function Testimonials() {
  ...
  return (
    ...
    >
      ...
      <div
        className={clsx(
          'inset-x-0 bottom-0 flex justify-center bg-gradient-to-t from-white pt-32 pb-8 pointer-events-none dark:from-zinc-900',
      ...
      >
        <button
          type="button"
          className={clsx(
            'relative bg-zinc-900 hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-zinc-400 focus:ring-offset-2 text-sm text-white font-semibold h-12 px-6 rounded-lg flex items-center dark:bg-zinc-700 dark:hover:bg-zinc-600',
            transition && 'transition-transform',
            expanded && !showCollapseButton && 'tranzinc-y-4',
