...
export function Header({ hasNav = false, navIsOpen, onNavToggle, title, section }) {
  ...
  return (
    <>
      <div
        className={clsx(
          'sticky top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 lg:border-b lg:border-zinc-900/10 dark:border-zinc-50/[0.06]',
          isOpaque
            ? 'bg-white supports-backdrop-blur:bg-white/95 dark:bg-zinc-900/75'
      ...
      >
        <div className="max-w-8xl mx-auto">
          <div
            className={clsx(
              'py-4 border-b border-zinc-900/10 lg:px-8 lg:border-0 dark:border-zinc-300/10',
          ...
          >
            <div className="relative flex items-center">
              ...
              <div className="relative hidden lg:flex items-center ml-auto">
                ...
                <div className="flex items-center border-l border-zinc-200 ml-6 pl-6 dark:border-zinc-800">
              ...
              <SearchButton className="ml-auto text-zinc-500 w-8 h-8 -my-1 flex items-center justify-center hover:text-zinc-600 lg:hidden dark:text-zinc-400 dark:hover:text-zinc-300">
